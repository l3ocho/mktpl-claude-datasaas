...
that the dmc-design resolver enforces automatically. Every component rendered in a
...
2. Or extend the schema at `mcp-servers/dmc-design/schemas/design-contract.schema.json`
