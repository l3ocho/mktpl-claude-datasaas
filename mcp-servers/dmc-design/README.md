# dmc-design MCP Server

Model Context Protocol (MCP) server for Dash Mantine Components validation and design system tools.
...
- **Accessibility**: WCAG contrast and color blindness validation
- **Design Contract**: Surface hierarchy resolver for consistent component rendering
...
- **Project-level**: `{project}/.dmc-design/themes/`
...
This MCP server is used by the `dmc-design` plugin. See the plugin's commands in `plugins/dmc-design/commands/` for usage.
