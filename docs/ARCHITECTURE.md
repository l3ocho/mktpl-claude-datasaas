...
- **References:** `references/dmc/` — AUTO-GENERATED DMC documentation split by domain (layout, ui, charts, feedback, theme). Generated by `scripts/generate-dmc-refs.py`.
